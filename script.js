...
const translations = {
    id: {
        ...
        'hero-description': 'Nikmati kelezatan empal gentong tradisional dengan resep turun temurun yang telah dipercaya selama puluhan tahun',
        'hero-cta': 'Lihat Menu',
        ...
        'story-p1': 'Empal Gentong Emak didirikan pada tahun 1995 oleh Ibu Siti Aminah, seorang ibu rumah tangga yang memiliki passion besar terhadap kuliner tradisional Cirebon. Berawal dari warung kecil di pinggir jalan, kini Empal Gentong Emak telah menjadi salah satu destinasi kuliner favorit di Cirebon.',
        'story-p2': 'Resep empal gentong yang kami gunakan merupakan warisan turun temurun dari nenek moyang yang telah dipertahankan keasliannya selama puluhan tahun. Setiap mangkuk empal gentong yang kami sajikan dibuat dengan penuh cinta dan dedikasi untuk memberikan pengalaman kuliner yang tak terlupakan.',
        'story-p3': 'Kami bangga menjadi bagian dari pelestarian kuliner tradisional Cirebon dan berkomitmen untuk terus menyajikan cita rasa autentik yang telah dipercaya oleh ribuan pelanggan setia.',
    ...
    en: {
        ...
        'hero-description': 'Enjoy the deliciousness of traditional empal gentong with ancestral recipes that have been trusted for decades',
        'hero-cta': 'View Menu',
        ...
        'story-p1': 'Empal Gentong Emak was founded in 1995 by Mrs. Siti Aminah, a housewife who has a great passion for traditional Cirebon cuisine. Starting from a small roadside stall, Empal Gentong Emak has now become one of the favorite culinary destinations in Cirebon.',
        'story-p2': 'The empal gentong recipe we use is an ancestral heritage that has been maintained for decades. Every bowl of empal gentong we serve is made with love and dedication to provide an unforgettable culinary experience.',
        'story-p3': 'We are proud to be part of preserving traditional Cirebon cuisine and are committed to continuing to serve authentic flavors that have been trusted by thousands of loyal customers.',
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const elements = document.querySelectorAll(".feature-card, .menu-card, .value-card, .team-member")
